...
async function start() {
  ...
  function seedDatabase() {
    ...
    if (prodCount === 0) {
      var laptops = [
        [1, 'Asus ROG Zephyrus G14', 'asus-rog-zephyrus-g14', 'Premium gaming laptop with AMD Ryzen 9, NVIDIA RTX 4060, 14-inch QHD display, and 16GB RAM.', 'Ryzen 9 | RTX 4060 | 14" QHD | 16GB RAM', 249900, 200000, 2000, 5000, 3000, 15, 'الألعاب', '', JSON.stringify([{ name: 'Color', values: ['Eclipse Gray', 'Moonlight White'] }, { name: 'RAM', values: ['16GB', '32GB'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD'] }])],
        ...
        [1, 'Asus TUF Gaming A15', 'asus-tuf-gaming-a15', 'Durable gaming laptop with AMD Ryzen 7, RTX 3050, 15.6-inch FHD 144Hz display.', 'Ryzen 7 | RTX 3050 | 15.6" FHD | 16GB RAM', 179900, 144000, 2000, 4000, 2500, 20, 'الألعاب', '', JSON.stringify([{ name: 'Color', values: ['Mecha Gray', 'Jaeger Gray'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD'] }])],
        ...
        [1, 'HP Envy 16', 'hp-envy-16', 'Creative laptop with Intel Core i7, 16-inch 2.5K display, and dedicated NVIDIA graphics.', 'Core i7 | 16" 2.5K | RTX 3050 | 16GB RAM', 219900, 176000, 2000, 5000, 3000, 12, 'العمل', '', JSON.stringify([{ name: 'Color', values: ['Natural Silver', 'Pewter'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD'] }])],
        ...
        [1, 'HP EliteBook 840 G11', 'hp-elitebook-840-g11', 'Business laptop with Intel Core Ultra 7, 14-inch FHD display, and enterprise-grade security.', 'Core Ultra 7 | 14" FHD | 16GB RAM | 512GB SSD', 229900, 184000, 2000, 4000, 3000, 8, 'العمل', '', JSON.stringify([{ name: 'Color', values: ['Silver'] }, { name: 'RAM', values: ['16GB', '32GB'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD'] }])],
        [1, 'Dell XPS 15', 'dell-xps-15', 'Premium ultrabook with Intel Core i7, 15.6-inch 3.5K OLED InfinityEdge display, and premium build.', 'Core i7 | 15.6" 3.5K OLED | 16GB RAM | 512GB SSD', 289900, 232000, 2000, 6000, 3000, 10, 'العمل', '', JSON.stringify([{ name: 'Color', values: ['Platinum Silver', 'Graphite'] }, { name: 'RAM', values: ['16GB', '32GB'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD'] }])],
        ...
        [1, 'Dell Latitude 5550', 'dell-latitude-5550', 'Business-class laptop with Intel Core i7, 15.6-inch FHD display, and robust security features.', 'Core i7 | 15.6" FHD | 16GB RAM | 512GB SSD', 199900, 160000, 2000, 4000, 3000, 15, 'العمل', '', JSON.stringify([{ name: 'Color', values: ['Titan Gray'] }, { name: 'RAM', values: ['16GB', '32GB'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD'] }])],
        [1, 'Dell Alienware m18', 'dell-alienware-m18', 'Extreme gaming laptop with Intel Core i9, NVIDIA RTX 4070, 18-inch QHD 165Hz display.', 'Core i9 | RTX 4070 | 18" QHD | 32GB RAM | 1TB SSD', 349900, 280000, 3000, 10000, 5000, 8, 'الألعاب', '', JSON.stringify([{ name: 'Color', values: ['Dark Side of the Moon'] }, { name: 'RAM', values: ['32GB', '64GB'] }, { name: 'Storage', values: ['1TB SSD', '2TB SSD'] }])],
        [1, 'Lenovo ThinkPad X1 Carbon Gen 12', 'lenovo-thinkpad-x1-carbon-gen-12', 'Ultralight business laptop with Intel Core Ultra 7, 14-inch 2.8K OLED, and legendary keyboard.', 'Core Ultra 7 | 14" 2.8K OLED | 16GB RAM | 512GB SSD', 299900, 240000, 2000, 6000, 3000, 10, 'العمل', '', JSON.stringify([{ name: 'Color', values: ['Black'] }, { name: 'RAM', values: ['16GB', '32GB'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD'] }])],
        [1, 'Lenovo Legion Pro 5', 'lenovo-legion-pro-5', 'High-performance gaming laptop with AMD Ryzen 7, RTX 4060, and 16-inch QHD display.', 'Ryzen 7 | RTX 4060 | 16" QHD | 16GB RAM', 229900, 184000, 2000, 5000, 3000, 15, 'الألعاب', '', JSON.stringify([{ name: 'Color', values: ['Onyx Grey', 'Glacier White'] }, { name: 'RAM', values: ['16GB', '32GB'] }, { name: 'Storage', values: ['1TB SSD', '2TB SSD'] }])],
        ...
        [1, 'Apple MacBook Air M3', 'macbook-air-m3', 'Ultrahin laptop with Apple M3 chip, 13.6-inch Liquid Retina display, and all-day battery life.', 'Apple M3 | 13.6" Liquid Retina | 8GB RAM | 256GB SSD', 179900, 144000, 2000, 5000, 3000, 20, 'الدراسة', '', JSON.stringify([{ name: 'Color', values: ['Midnight', 'Starlight', 'Space Gray', 'Silver'] }, { name: 'RAM', values: ['8GB', '16GB', '24GB'] }, { name: 'Storage', values: ['256GB SSD', '512GB SSD', '1TB SSD'] }])],
        [1, 'Apple MacBook Pro 14 M4 Pro', 'macbook-pro-14-m4-pro', 'Professional laptop with Apple M4 Pro chip, 14.2-inch Liquid Retina XDR display, and pro performance.', 'Apple M4 Pro | 14.2" Liquid Retina XDR | 18GB RAM | 512GB SSD', 349900, 280000, 3000, 8000, 5000, 15, 'العمل', '', JSON.stringify([{ name: 'Color', values: ['Silver', 'Space Black'] }, { name: 'RAM', values: ['18GB', '36GB'] }, { name: 'Storage', values: ['512GB SSD', '1TB SSD', '2TB SSD'] }])],
        [1, 'Apple MacBook Pro 16 M4 Max', 'macbook-pro-16-m4-max', 'Flagship professional laptop with Apple M4 Max chip, 16.2-inch Liquid Retina XDR display, and extreme power.', 'Apple M4 Max | 16.2" Liquid Retina XDR | 36GB RAM | 1TB SSD', 499900, 400000, 3000, 12000, 6000, 10, 'العمل', '', JSON.stringify([{ name: 'Color', values: ['Silver', 'Space Black'] }, { name: 'RAM', values: ['36GB', '64GB', '128GB'] }, { name: 'Storage', values: ['1TB SSD', '2TB SSD', '4TB SSD'] }])],
        [1, 'Apple MacBook Air M2', 'macbook-air-m2', 'Slim and capable laptop with Apple M2 chip, 13.6-inch Liquid Retina display, and MagSafe charging.', 'Apple M2 | 13.6" Liquid Retina | 8GB RAM | 256GB SSD', 149900, 120000, 2000, 4000, 2500, 25, 'الدراسة', '', JSON.stringify([{ name: 'Color', values: ['Midnight', 'Starlight', 'Space Gray', 'Silver'] }, { name: 'RAM', values: ['8GB', '16GB'] }, { name: 'Storage', values: ['256GB SSD', '512GB SSD'] }])],
      ];
      ...
      var attrData = [
        [1, 'Color', ['Eclipse Gray', 0], ['Moonlight White', 0]], [1, 'RAM', ['16GB', 0], ['32GB', 15000]], [1, 'Storage', ['512GB SSD', 0], ['1TB SSD', 20000]],
        [2, 'Color', ['Ponder Blue', 0], ['Foggy Silver', 0]], [2, 'RAM', ['16GB', 0], ['32GB', 15000]],
        [3, 'Color', ['Mecha Gray', 0], ['Jaeger Gray', 0]], [3, 'Storage', ['512GB SSD', 0], ['1TB SSD', 20000]],
        ...
        [6, 'Color', ['Natural Silver', 0], ['Pewter', 0]], [6, 'Storage', ['512GB SSD', 0], ['1TB SSD', 20000]],
        [7, 'Color', ['Silver', 0], ['Gold', 0]], [7, 'RAM', ['4GB', -5000], ['8GB', 0], ['16GB', 10000]],
        [8, 'Color', ['Silver', 0]], [8, 'RAM', ['16GB', 0], ['32GB', 15000]], [8, 'Storage', ['512GB SSD', 0], ['1TB SSD', 20000]],
        [9, 'Color', ['Platinum Silver', 0], ['Graphite', 0]], [9, 'RAM', ['16GB', 0], ['32GB', 20000]], [9, 'Storage', ['512GB SSD', 0], ['1TB SSD', 25000]],
        [10, 'Color', ['Platinum Silver', 0], ['Carbon Black', 0]], [10, 'RAM', ['4GB', -5000], ['8GB', 0], ['16GB', 10000]],
        [11, 'Color', ['Titan Gray', 0]], [11, 'RAM', ['16GB', 0], ['32GB', 15000]], [11, 'Storage', ['512GB SSD', 0], ['1TB SSD', 20000]],
        [12, 'Color', ['Dark Side of the Moon', 0]], [12, 'RAM', ['32GB', 0], ['64GB', 25000]], [12, 'Storage', ['1TB SSD', 0], ['2TB SSD', 25000]],
        [13, 'Color', ['Black', 0]], [13, 'RAM', ['16GB', 0], ['32GB', 20000]], [13, 'Storage', ['512GB SSD', 0], ['1TB SSD', 25000]],
        [14, 'Color', ['Onyx Grey', 0], ['Glacier White', 0]], [14, 'RAM', ['16GB', 0], ['32GB', 15000]], [14, 'Storage', ['1TB SSD', 0], ['2TB SSD', 20000]],
        ...
        [17, 'Color', ['Midnight', 0], ['Starlight', 0], ['Space Gray', 0], ['Silver', 0]], [17, 'RAM', ['8GB', 0], ['16GB', 15000], ['24GB', 30000]], [17, 'Storage', ['128GB SSD', -5000], ['256GB SSD', 0], ['512GB SSD', 15000], ['1TB SSD', 30000]],
        [18, 'Color', ['Silver', 0], ['Space Black', 0]], [18, 'RAM', ['18GB', 0], ['36GB', 20000]], [18, 'Storage', ['512GB SSD', 0], ['1TB SSD', 20000], ['2TB SSD', 40000]],
        [19, 'Color', ['Silver', 0], ['Space Black', 0]], [19, 'RAM', ['36GB', 0], ['64GB', 25000], ['128GB', 50000]], [19, 'Storage', ['1TB SSD', 0], ['2TB SSD', 30000], ['4TB SSD', 60000]],
        [20, 'Color', ['Midnight', 0], ['Starlight', 0], ['Space Gray', 0], ['Silver', 0]], [20, 'RAM', ['8GB', 0], ['16GB', 15000]], [20, 'Storage', ['128GB SSD', -5000], ['256GB SSD', 0], ['512GB SSD', 15000]],
      ];
