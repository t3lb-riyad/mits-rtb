      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-6">
            <a href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="whatsapp-btn w-full sm:w-auto justify-center">
            ...
            <a href={`tel:${import.meta.env.VITE_PHONE_NUMBER}`} className="inline-flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-sm text-sm font-medium hover:bg-blue-800 transition-colors w-full sm:w-auto justify-center">
